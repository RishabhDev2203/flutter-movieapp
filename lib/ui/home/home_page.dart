...
class _HomePageState extends State<HomePage> {
            ...
            child: ListView(
              ...
              children: [
                ...
                ListView.separated(
                  ...
                  itemCount: _categoryList != null && _categoryList!.isNotEmpty
                  ...
                  itemBuilder: (BuildContext context, int categoryIndex) {
                    return Column(
                      ...
                      children: [
                        _categoryList?[categoryIndex].library != null &&
                        ...
                        _categoryList?[categoryIndex].library != null &&
                            ...
                            ? SizedBox(
                                ...
                                child: ListView.separated(
                                  ...
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  itemCount: _categoryList![categoryIndex]
                                          .library
                                          ?.length ??
                                      0,
                                  itemBuilder:
                  ...
                  separatorBuilder: (BuildContext context, int categoryIndex) {
                    return SizedBox(
                      height: _categoryList?[categoryIndex].library != null &&
                              _categoryList![categoryIndex].library!.isNotEmpty
                          ? 20
                          : 0,
                    );
                  },
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => HomeDetailPage(
                    id: _libraryList?[index]?.libraryId,
                    coverImage: _libraryList?[index]?.thumbnails?[0].url,
                    heroTag: heroTag))).then((value) => {
              _appSession.init().then((value) => getDetail()),
              getBannerMovieList(),
              getFeaturedLists(),
              getContinueWatchingList()
  ...
  Widget _continueList(int index) {
    ...
    var seenTime =
        '${(Duration(seconds: _continueWatchList?[index].watchDurationInSec ?? 0))}'
            .split('.')[0]
            .padLeft(8, '0');
    var totalTime =
        '${(Duration(seconds: _continueWatchList?[index].totalLength ?? 0))}'
            .split('.')[0]
            .padLeft(8, '0');
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => HomeDetailPage(
                    id: _continueWatchList?[index].libraryContent?.libraryId,
                    coverImage: _continueWatchList?[index]
                        .libraryContent
                        ?.thumbnails?[0]
                        .url,
                    watchingDto: _continueWatchList?[index]))).then((value) => {
              _appSession.init().then((value) => getDetail()),
              getBannerMovieList(),
              getFeaturedLists(),
              getContinueWatchingList()
        ...
        children: [
          ClipRRect(
            ...
            child: CachedNetworkImage(
              height: 120,
              width: 196,
              imageUrl: _continueWatchList?[index]
                      .libraryContent
                      ?.thumbnails?[1]
                      .url ??
                  "",
      ...
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => HomeDetailPage(
                    id: dto?.libraryId,
                    coverImage: dto?.thumbnails?[0].url))).then((value) => {
              _appSession.init().then((value) => getDetail()),
              getBannerMovieList(),
              getFeaturedLists(),
              getContinueWatchingList()
          ...
          children: [
            ClipRRect(
              ...
              child: CachedNetworkImage(
                height: 130,
                width: 100,
                imageUrl: dto?.thumbnails != null && dto!.thumbnails!.isNotEmpty
                    ? dto.thumbnails![0].url ?? ""
                    : "",
                fit: BoxFit.cover,
                placeholder: (context, url) => Container(
                  color: Colors.black38,
